...
class OtpTextView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray, attrs: AttributeSet?) {
        ...
        if (length > 0) {
            ...
            val inputType = styles.getInt(R.styleable.OtpTextView_android_inputType , InputType.TYPE_CLASS_NUMBER)
    ...
    public fun setOtpViewInputType(input : Int)
    {
        otpChildEditText?.setOtpViewInputType(input)
    }
